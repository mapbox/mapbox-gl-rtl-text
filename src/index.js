const {instance} = await WebAssembly.instantiateStreaming(
    fetch(new URL('../dist/mapbox-gl-rtl-text.wasm', import.meta.url)),
    {
        env: {
...
export function processBidirectionalText(input, lineBreakPoints) {
    ...
    const mergedLineBreakPoints = mergeParagraphLineBreakPoints(lineBreakPoints, paragraphCount);
    ...
    for (const lineBreakPoint of mergedLineBreakPoints) {
        let lineText = '';
